...
import { IsBoolean, IsEnum, IsInt, IsNumber, IsOptional, IsString, IsUUID, Matches, Max, MaxLength, Min, MinLength } from "class-validator";
...
export class UpdateFixedExpenseDto {
  ...
  @IsOptional()
  @IsBoolean({ message: "활성 여부를 다시 확인해 주세요." })
  isActive?: boolean;
}
